...
///////////////////////////////////////////////////////////////////////////////
//
int BufIO::GetWriteReady() { return 0; }

///////////////////////////////////////////////////////////////////////////////
//
int BufIO::Write(const sstring &buf) {
  return Write(buf.u_str(), buf.length());
}
...
///////////////////////////////////////////////////////////////////////////////
//
int BufIO::GetReadReady() { return 0; }
...
///////////////////////////////////////////////////////////////////////////////
//
BufIOCRefT *BufIO::GetCRef() { return &this->thisRef; }
...
///////////////////////////////////////////////////////////////////////////////
//
int BufIOWrite(const BufIOCRefT *const pBaseIo, const uint8_t *const pBytes,
               const int numBytes) {
...
///////////////////////////////////////////////////////////////////////////////
//
int BufIORead(const BufIOCRefT *const pBaseIo, uint8_t *const pBytes,
              const int numBytes) {
  BufIO *const pBleIo = static_cast<BufIO *>(pBaseIo->pThis);
