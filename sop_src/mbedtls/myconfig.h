...
#if (PLATFORM_FULL_OS > 0) && (!defined(ANDROID)) && (!(TARGET_OS_IOS > 0))
/**
...
/**
* \def MBEDTLS_MEMORY_FILETRACE
*
* Include filetrace with each allocated block
*
* Requires: MBEDTLS_MEMORY_BUFFER_ALLOC_C
*
* Uncomment this macro to include filetrace information
*/
#define MBEDTLS_MEMORY_FILETRACE
#endif
/**
...
#if (PLATFORM_FULL_OS > 0) && !defined(MBEDTLS_NO_SOCKETS)
/**
* \def MBEDTLS_NET_C
*
...
#if defined(MBEDTLS_PLATFORM_NV_SEED_READ) && defined(MBEDTLS_PLATFORM_NV_SEED_WRITE)
#define MBEDTLS_ENTROPY_NV_SEED
#endif
...
#if defined(BUILDING_LIBCRYPTO)
#define MBEDTLS_PLATFORM_CALLOC_MACRO          lcal_calloc /**< Default allocator macro to use, can be undefined */
#define MBEDTLS_PLATFORM_FREE_MACRO            lcal_free /**< Default free macro to use, can be undefined */
#endif
//#define MBEDTLS_PLATFORM_EXIT_MACRO            exit /**< Default exit macro to use, can be undefined */
//#define MBEDTLS_PLATFORM_TIME_MACRO            time /**< Default time macro to use, can be undefined. MBEDTLS_HAVE_TIME must be enabled */
//#define MBEDTLS_PLATFORM_TIME_TYPE_MACRO       lcal_time_t /**< Default time macro to use, can be undefined. MBEDTLS_HAVE_TIME must be enabled */
//#define MBEDTLS_PLATFORM_FPRINTF_MACRO          lcal_fprintf
//#define MBEDTLS_PLATFORM_PRINTF_MACRO           lcal_printf
/* Note: your snprintf must correclty zero-terminate the buffer! */
//#define MBEDTLS_PLATFORM_SNPRINTF_MACRO         lcal_snprintf
//#define MBEDTLS_PLATFORM_NV_SEED_READ_MACRO     lcal_nv_seed_read
//#define MBEDTLS_PLATFORM_NV_SEED_WRITE_MACRO    lcal_nv_seed_write
...
*/
//#define MBEDTLS_PLATFORM_GMTIME_R_ALT lcal_gmtime
...
#undef PLATFORM_FULL_OS
#undef PLATFORM_EMBEDDED
#define PLATFORM_FULL_OS PLATFORM_FULL_OS_OLD
#define PLATFORM_EMBEDDED PLATFORM_EMBEDDED_OLD
#endif
