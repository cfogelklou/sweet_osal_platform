...
public:
	static void PrintFakeScreenToScreen(FakeScreen& s, std::ostream& o) {
...
public:
	...
	SP_DataSetT& GenerateDataset(pFnGetYValue cb, std::string label = "", void* pUserData = nullptr) {
		...
		d.GetYValue = [](struct SP_DataSetTag* pDS, SP_FloatT fX, SP_FloatT* pfY) {
			*pfY = fX;
